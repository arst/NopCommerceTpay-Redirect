...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CheckFields :  IEquatable<CheckFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckFields" /> class.
        /// </summary>
        /// <param name="ApiPassword">ApiPassword.</param>
        public CheckFields(CardApiPassword ApiPassword = default(CardApiPassword))
        {
        ...
        {
            return this.Equals(input as CheckFields);
        }

        /// <summary>
        /// Returns true if CheckFields instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckFields input)
        {
            if (input == null)
                return false;
