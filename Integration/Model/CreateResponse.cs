...
namespace IO.Swagger.Model
{
    ...
    public partial class CreateResponse :  IEquatable<CreateResponse>, IValidatableObject
    {
        ...
        public CreateResponse(Result Result = default(Result), TransactionErrorCodes Err = default(TransactionErrorCodes), Title Title = default(Title), Amount Amount = default(Amount), decimal? AccountNumber = default(decimal?), int? Online = default(int?), string Url = default(string), string Desc = default(string))
        {
